...
function f_selectInit()
	p1SelX = 0
	p1SelY = 0
	p2SelX = 1 --Cursor position after choosing the Team Mode (Single, Team or Turns), this is used to put p2 in the 4th slot
	p2SelY = 0
	p1FaceOffset = 0
	p2FaceOffset = 0
	p1OffsetRow = 0
...
function f_arcadeEnd()
	if data.rosterMode == "arcade" then
		...
		if unlockTarget[1].displayname == "Character Selected" then data.char1 = true end --Character Unlock
		f_saveProgress()
